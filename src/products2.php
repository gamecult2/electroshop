...
<div class="container-xxl pb-4">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body p-4">
            <form id="filter-form" method="GET" action="products2.php">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="search" class="form-control border-start-0 ps-0" value="<?php echo htmlspecialchars($search ?? ''); ?>" placeholder="<?php echo t('search_products'); ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="min_price" class="form-control" value="<?php echo htmlspecialchars($minPrice ?? ''); ?>" placeholder="Min">
                            <span class="input-group-text bg-light text-muted border-start-0 border-end-0">-</span>
                            <input type="number" name="max_price" class="form-control" value="<?php echo htmlspecialchars($maxPrice ?? ''); ?>" placeholder="Max">
                        </div>
                    </div>
                    ...
                    <div class="col-md-1 d-flex gap-2">
                        <button type="submit" class="btn btn-danger w-100" title="<?php echo t('apply_filters'); ?>"><i class="fas fa-filter"></i></button>
                        <?php if ($search || $categoryId || $minPrice || $maxPrice || $sort != 'default'): ?>
                            <a href="products2.php" class="btn btn-outline-secondary w-100" title="<?php echo t('clear_filters'); ?>"><i class="fas fa-times"></i></a>
                        <?php endif; ?>
                    </div>
                </div>
            </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('items-per-page').addEventListener('change', function() {
        ...
        window.location.href = `products2.php?${params.toString()}`;
    });
});
</script>
